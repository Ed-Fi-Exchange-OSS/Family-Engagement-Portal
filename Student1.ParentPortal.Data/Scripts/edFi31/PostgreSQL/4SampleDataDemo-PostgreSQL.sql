...
BEGIN
      ...
      INSERT INTO ParentPortal.StudentAllAbout (StudentAllAboutId, StudentUSI, PrefferedName, FunFact, TypesOfBook, FavoriteAnimal, FavoriteThingToDo, FavoriteSubjectSchool, OneThingWant, LearnToDo, LearningThings, DateCreated, DateUpdated) SELECT (1, 435, N'Hannah', N'I am funny', N'Sci-Fi', N'Dogs are cute', N'Reading', N'Math', N'Travel', N'Math', N'Yes', CAST(N'2021-02-24T17:49:04.427' AS TIMESTAMP(3)), CAST(N'2021-02-24T17:49:04.427' AS TIMESTAMP(3)));

      INSERT INTO ParentPortal.Admin (AdminUSI, ElectronicMailAddress, CreateDate, LastModifiedDate, Id) SELECT (3, N'trent.newton@toolwise.onmicrosoft.com', CAST(N'2020-06-03T00:00:00.0000000' AS TIMESTAMP(6)), CAST(N'2020-06-03T00:00:00.0000000' AS TIMESTAMP(6)), N'a3b7e2df-de0c-43ce-8e6d-2da37e3b0ab3');
      ...
      INSERT INTO edfi.StudentDisciplineIncidentAssociation
            ...
            ,CreateDate,LastModifiedDate,Id,ChangeVersion)
      VALUES
            (30,v_middleSchoolId,v_studentMaleUSI,2258,null,NOW(),NOW(),uuid_generate_v4(),17743);
      ...
      values('SAT MATH', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('SAT EBRW', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );

      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('PSAT MATH', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('PSAT EBRW', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );

      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR English I', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR Algebra I', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR English II', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMeets, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR Biology', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR U.S. History', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentFemaleUSI, 1 );

      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR READING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR MATHEMATICS', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR WRITING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMeets, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SCIENCE', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SOCIAL STUDIES', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq', v_studentMaleUSI, 1 );

      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR READING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq1', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR MATHEMATICS', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq1', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR WRITING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMeets, 'iwenfwf319r9r9v8noAWWDQN9dq1', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SCIENCE', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq1', v_studentMaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SOCIAL STUDIES', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq1', v_studentMaleUSI, 1 );
      ...
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR READING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq2', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR MATHEMATICS', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorApproaches, 'iwenfwf319r9r9v8noAWWDQN9dq2', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR WRITING', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq2', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SCIENCE', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorDidNotMeet, 'iwenfwf319r9r9v8noAWWDQN9dq2', v_studentFemaleUSI, 1 );
      insert into edfi.StudentAssessmentPerformanceLevel(AssessmentIdentifier, AssessmentReportingMethodDescriptorId, Namespace, PerformanceLevelDescriptorId, StudentAssessmentIdentifier, StudentUSI, PerformanceLevelMet)
      values('STAAR SOCIAL STUDIES', v_assessmentReportingMethodDescriptor, 'uri://ed-fi.org/Assessment/Assessment.xml', v_performanceLevelDescriptorMaster, 'iwenfwf319r9r9v8noAWWDQN9dq2', v_studentFemaleUSI, 1 );
      ...
      */
      ...
      VALUES
            (v_studentFemaleGoalAcademic,'identify all consonant and vowel sounds',1,NOW(),NOW(),1,NULL),
                  (v_studentFemaleGoalAcademic,'identify beginning, middle and ending sounds',1,NOW(),NOW(),1,NULL),
                  (v_studentFemaleGoalAcademic,'be able to cumulativley blend 2 and 3 phoneme words',1,NOW(),NOW(),1,NULL),

                  (v_studentFemaleGoalCareer,'Use planning and organizational tools such as checklists and picture schedules to stay on track',0,NOW(),NOW(),1,NULL),
                  (v_studentFemaleGoalCareer,'Goal for completion of work; use of paper tracker or google form to track completed assignemnts',0,NOW(),NOW(),1,NULL),
                  (v_studentFemaleGoalCareer,'use of stress management strategies such as short breaks and use of cool down station in classroom',0,NOW(),NOW(),1,NULL),
                  (v_studentFemaleGoalPersonal,'Identify career clusters in occupations within the community that I would be interested in',0,NOW(),NOW(),1,NULL);
      ...
      INSERT INTO ParentPortal.StudentGoalStep
            ...
            ,DateUpdated,IsActive,StudentGoalInterventionId)
      VALUES
            (v_studentMaleGoalAcademic,'identify all consonant and vowel sounds',1,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalAcademic,'identify beginning, middle and ending sounds',1,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalAcademic,'be able to cumulativley blend 2 and 3 phoneme words',1,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalCareer,'Use planning and organizational tools such as checklists and picture schedules to stay on track',0,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalCareer,'Goal for completion of work; use of paper tracker or google form to track completed assignemnts',0,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalCareer,'use of stress management strategies such as short breaks and use of cool down station in classroom',0,NOW(),NOW(),1,NULL),
                  (v_studentMaleGoalPersonal,'Identify career clusters in occupations within the community that I would be interested in',0,NOW(),NOW(),1,NULL);
      ...
      VALUES 
      (N'AccessScores_2019', N'uri://ed-fi.org/Assessment/Assessment.xml', N'Access Scores', v_AssessmentCategoryDescriptorId, NULL, 2019, NULL, 6.0, NULL, NULL, 255901001, NULL, CAST(N'2019-10-31T13:36:16.000' AS TIMESTAMP(3)), CAST(N'2019-10-31T13:36:16.250' AS TIMESTAMP(3)), N'e6b0a3b2-4866-4050-a69e-6e9ea0df9682');
      ...
      INSERT INTO edfi.Assessment (AssessmentIdentifier, Namespace, AssessmentTitle, AssessmentCategoryDescriptorId, AssessmentForm, AssessmentVersion, RevisionDate, MaxRawScore, Nomenclature, AssessmentFamily, EducationOrganizationId, AdaptiveAssessment, CreateDate, LastModifiedDate, Id) 
      VALUES 
      (N'AccessScores_2018', N'uri://ed-fi.org/Assessment/Assessment.xml', N'Access Scores', v_AssessmentCategoryDescriptorId, NULL, 2018, NULL, 6.0, NULL, NULL, 255901001, NULL, CAST(N'2019-12-11T15:05:39.000' AS TIMESTAMP(3)), CAST(N'2019-12-11T15:05:39.300' AS TIMESTAMP(3)), N'785e03b2-a06d-480b-8f9a-92803f8e8787');
      ...
      INSERT INTO edfi.StudentAssessmentScoreResult
            ...
            ,StudentUSI,Result,ResultDatatypeTypeDescriptorId,CreateDate)
      VALUES
            ('AccessScores_2018',v_AssessmentReportingMethodDescriptorRawScore,'uri://ed-fi.org/Assessment/Assessment.xml',v_AssesmentIdentifierMale2018,v_studentMaleUSI,4.9,v_ResultDatatypeTypeDescriptorDecimal,CURRN);
      ...
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numb_Numb_WholeNumbers:PlaceValue', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'56', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Geometry_Geometry_Angles Segments and Lines', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'48', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numb_Numb_Decimal Concepts and Operations', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'17', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numb_Numb_FractionConceptsandOperations', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'25', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Meas_Meas_PerimeterCircumferenceandArea', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'39', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numb_Numb_WholeNumbers:AdditionandSubtraction', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'18', 2013, N'2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Measurement and Data_Measurement and Data_Measurement', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'49', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Geometry_Geometry', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'17', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Alge_Oper_WholeNumbers:MultiplicationandDivision', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'17', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Measurement and Data_Measurement and Data', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'33', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numbers and Operations_Number and Operations in Base Ten', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'18', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Algebra_Operations and Algebraic Thinking', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'42', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Meas_Meas_DataRepresentationandAnalysis', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'33', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numbers and Operations_Number and Operations—Fractions', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'20', 2013, '2020-01-20 01:47:14');
      INSERT INTO edfi.StudentAssessmentStudentObjectiveAssessmentScoreResult (AssessmentIdentifier, AssessmentReportingMethodDescriptorId, IdentificationCode, Namespace, StudentAssessmentIdentifier, StudentUSI, Result, ResultDatatypeTypeDescriptorId, CreateDate) VALUES (N'STAR_Math_2019', 212, N'Numb_Numb_WholeNumbers:MultiplicationandDivision', N'http://ed-fi.org/Assessment/Assessment.xml', N'561857', 721, N'35', 2013, '2020-01-20 01:47:14');
