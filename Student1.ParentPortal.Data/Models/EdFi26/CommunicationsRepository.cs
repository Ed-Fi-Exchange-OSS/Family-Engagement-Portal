...
namespace Student1.ParentPortal.Data.Models.EdFi26
{
    public class CommunicationsRepository : ICommunicationsRepository
    {
        ...
        public CommunicationsRepository(EdFi26Context edFiDb)
        {
            _edFiDb = edFiDb;
        }
        ...
        public Task SetRecipientsRead(string studentUniqueId, string senderUniqueId, int senderTypeid, string recipientUniqueId, int recipientTypeId)
        {
            throw new NotImplementedException();
        }

        public Task<AllRecipients> GetAllParentRecipients(int? studentUsi, string recipientUniqueId, int recipientTypeId, int rowsToSkip, int rowsToRetrieve, string[] validLeadersDescriptors, DateTime today)
        {
            throw new NotImplementedException();
        }

        public Task<AllRecipients> GetAllStaffRecipients(int? studentUsi, string recipientUniqueId, int recipientTypeId, int rowsToSkip, int rowsToRetrieve, DateTime today)
        {
            throw new NotImplementedException();
        }

        public Task<List<UnreadMessageModel>> PrincipalRecipientMessages(string recipientUniqueId, int recipientTypeId, int rowsToSkip, int rowsToRetrieve, string searchTerm, bool onlyUnreadMessages)
        {
            throw new NotImplementedException();
        }

        public Task<int> PrincipalRecipientMessagesCount(string recipientUniqueId, int recipientTypeId, string searchTerm, bool onlyUnreadMessages)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<ParentStudentsModel>> GetParentsByGradeLevelsAndPrograms(string personUniqueId, int[] grades, int[] programs, string[] validParentDescriptors, string[] validEmailTypeDescriptors, DateTime today)
        {
            throw new NotImplementedException();
        }

        public Task<GroupMessagesQueueLogModel> PersistQueueGroupMessage(GroupMessagesQueueLogModel model)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<GroupMessagesQueueLogModel>> GetGroupMessagesQueuesQueued()
        {
            throw new NotImplementedException();
        }

        public Task<List<GroupMessagesQueueLogModel>> GetGroupMessagesQueuesQueued(string staffUniqueId, int schoolId, QueuesFilterModel model)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<GroupMessagesQueueLogModel> GetGroupMessagesQueue(Guid Id)
        {
            throw new NotImplementedException();
        }

        public Task<List<ParentStudentsModel>> GetParentsByPanrentUsisAndGradeLevels(string personUniqueId, int[] parentUsis, int[] gradeLevels, string[] validParentDescriptors, string[] validEmailTypeDescriptors, DateTime today)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<ParentStudentsModel>> GetParentsByGradeLevelsAndSearchTerm(string personUniqueId, string term, GradesLevelModel model, string[] validParentDescriptors, DateTime today, int schoolId)
        {
            throw new NotImplementedException();
        }
